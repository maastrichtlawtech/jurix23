...
_There is no AGI on the horizon, and AI cannot replace people’s (legal) thinking and judging_ <p style='font-size:90%'>(based on recent interdisciplinary work published as[ "Reclaiming AI as a theoretical tool for cognitive science"](https://osf.io/preprints/psyarxiv/4cbuv/) together with Olivia Guest, Federico Adolfi, Ronald de Haan, Antonina Kolokolova, & Patricia Rich)</p> 
